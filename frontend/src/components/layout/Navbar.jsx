...
import { Book, Newspaper, Home, Info, Phone, LogIn, CreditCard, Languages, ShoppingCart, MessageSquare } from "lucide-react";
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a
                        ...
                        className="btn-premium bg-primary text-white hover:bg-primary-dark shadow-md flex items-center gap-2 text-sm"
                    >
